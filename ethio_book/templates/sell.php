...
<?php if (isset($_SESSION['is_seller']) || isset($_SESSION['is_admin'])) : ?>
    <?php displayMessage(); ?>
        ...
        <form method="post" action="sell.php" enctype="multipart/form-data">
            ...
            <?php if (isset($_SESSION['is_admin'])) : ?>
                <?php if (!empty($_SESSION['is_admin'])) : ?>
                    ...
                    <div class="form-group">
                        <label for="">Premium Service</label>
                        <input type="number" name="premium" class="ml-2">
                        <small class="form-text text-muted">Number are valued in terms of days</small>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
